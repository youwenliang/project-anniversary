...
class App extends Component {
  ...
  render() {
    ...
    return (
      <div className="App">
        <div className="text">
          <p style={margin}>結婚一週年快樂！🎉🎉🎉</p>
          <p>新婚生活的第一年轉眼就過了，也代表我們從認識到現在已經快九年了！現在已經習慣一直有彼此在身邊，實在很難想像當初曾經這麼長時間的遠距離。這一年一起生活的日子讓我們變的更有默契，常常可以馬上知道你腦中浮出的想法，讓我都懷疑自己是不是會讀心術了😁。只能說我們是越來越懂彼此，也越來越能包容各自的優缺點．<br/>未來的日子也要繼續照顧彼此喔！😘</p>
